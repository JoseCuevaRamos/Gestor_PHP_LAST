...
$container['validateJwt'] = function ($c) {
    $secret = $c->get('settings')['jwt']['secret'];
    return new \Conduit\Middleware\ValidateJwt($secret);
};
...
$container['Conduit\Services\PhotosDrive\GoogleDriveService'] = function ($c) {
    return new \Conduit\Services\PhotosDrive\GoogleDriveService();
};